...
@Component({
  selector: 'app-dp-tooltip',
  templateUrl: './dp-tooltip.component.html',
  styleUrls: ['./dp-tooltip.component.scss'],
})
export class DpTooltipComponent implements AfterViewInit {
